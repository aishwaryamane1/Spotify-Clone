...
<head>
    ...
    <style>
    header .song::before{
        background: url("./img/bg/darshan_bg.jpg");
        padding-right: 20px;
        opacity: 1;
    }
    </style>
    ...
    <header>
        <div class="menu">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="./img/Darshan_Posters/1.jpeg" alt="">
                    <h5>On my way
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="./img/Darshan_Posters/2.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="./img/Darshan_Posters/3.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="./img/Darshan_Posters/4.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="./img/Darshan_Posters/5.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="./img/Darshan_Posters/6.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>07</span>
                    <img src="./img/Darshan_Posters/7.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>08</span>
                    <img src="./img/Darshan_Posters/8.jpeg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
        ...
        <div class="song">
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/9.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/10.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/11.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/12.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/13.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/14.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/15.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/16.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/17.jpeg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Darshan_Posters/18.jpeg" alt="">
        ...
        <div class="play">
            ...
            <img src="./img/Darshan_Posters/1.jpeg" alt="" id="poster_play">

            <h5 id="title"> Bhula Dunga
