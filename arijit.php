...
<head>
    ...
    <style>
    header .song::before{
        background: url("img/bg/arjit_bg.png");
        padding-right: 20px;
        opacity: 1;
    }
    </style>
    ...
    <header>
        <div class="menu">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="./img/Arijit_Posters/1.jpg" alt="">
                    <h5>On my way
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="./img/Arijit_Posters/2.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>03</span>
                    <img src="./img/Arijit_Posters/3.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>04</span>
                    <img src="./img/Arijit_Posters/4.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>05</span>
                    <img src="./img/Arijit_Posters/5.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>06</span>
                    <img src="./img/Arijit_Posters/6.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>07</span>
                    <img src="./img/Arijit_Posters/7.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
                ...
                <li class="songItem">
                    <span>08</span>
                    <img src="./img/Arijit_Posters/8.jpg" alt="">
                    <h5>On my way
                        <br> <div class="subtitle">Alan Walker</div>
                    </h5>
        ...
        <div class="song">
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/9.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/10.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/11.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/12.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/13.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/14.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/15.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/16.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/17.jpg" alt="">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="./img/Arijit_Posters/18.jpg" alt="">
        ...
        <div class="play">
            ...
            <img src="./img/Arijit_Posters/1.jpg" alt="" id="poster_play">

            <h5 id="title"> Neki Ki Raah
